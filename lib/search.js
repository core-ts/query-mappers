...
var QueryBuilder = (function () {
  ...
  QueryBuilder.prototype.buildQuery = function (filter, param, sn, buildSort, attrs) {
    var f2 = this.buildFilter(filter, this.q, this.useContain, this.attributes ? this.attributes : attrs);
    if (sn && sn.length > 0 && buildSort) {
      var sort = buildSort(sn, attrs ? attrs : this.attributes);
      f2[this.sort] = sort;
    }
    return core_1.build(f2, this.template, param);
  };
  return QueryBuilder;
}());
